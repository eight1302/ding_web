...
(function (factory) {
    ...
    tImage = '<img src="{data}" class="kv-preview-data file-preview-image" title="{caption}" alt="{caption}" ' +
        STYLE_SETTING + '>\n';
    tText = '<textarea class="kv-preview-data file-preview-text" style="height:-20px;" title="{caption}" readonly ' + STYLE_SETTING +
        '>{data}</textarea>\n';
    ...
    FileInput.prototype = {
        ...
        _showUploadError: function (msg, params, event) {
            ...
            '<li data-file-id="' + params.id + '">' + msg1 + '</li>' : '<li>' + msg1 + '</li>';
